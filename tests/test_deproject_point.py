...
source_pixels = healpy.query_disc( map_nside, (1,0,0), numpy.radians(1) )
...
ra   = numpy.asarray(  (0.0,0.0) )
dec  = numpy.asarray(  (0.0) )
...
print 'Deprojection at 0 degrees' , pisco_tod[0]
...
pisco_tod = deproject_sky_for_feedhorn(
    ...
    (I_map,Q_map,U_map,V_map),
    beam_nside, beam0_co,beam0_cx, beam90_co, beam90_cx )
print 'Deprojection at 90 degrees' , pisco_tod[0]
...
print 'Deprojection at 45 degrees' , pisco_tod[0]
