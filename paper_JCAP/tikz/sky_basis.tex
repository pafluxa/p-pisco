...
\begin{document}
	...
	\draw[thick,color=red,->] (O) -- (P) node[anchor=south]{$\hat{p}$};
	...
	% draw hat_theta
	\draw[thick,tdplot_rotated_coords,->] (0,0,0) -- (.3,0,0) node[anchor=south west]{$\hat{\theta}$};
	% draw hat_phi
	...
	% draw hat_theta_prime
	\draw[thick,tdplot_rotated_coords,color=blue,->] (0,0,0) -- (.3,0,0) node[anchor=east]{$\hat{\theta}'$};
	% draw hat_phi_prime
