...
%\begin{figure}
%	\centering
%	\includegraphics[width=1.0\linewidth]{figures/spherical_triangle_a2s}
%	\caption{Figure showing all the relevant angles used in the derivation of antenna coordinates given a pointing $\bar{q}$ in equatorial coordinates and a pair of equatorial coordinates $(RA,\mathrm{dec})$. $\rho$ is the parallactic angle at beam center, $\beta$ is the rotation of the beam with respect to pointing $\bar{q}$, ``up'' is the beam coordinate pole. $\Delta RA$ is positive clockwise.}
%	\label{fig::sphericaltrianglea2s}
%\end{figure}
