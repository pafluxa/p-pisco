...
# Perform projection
I_proj = proj.projmap( I - I_o_s, vec2pix_func )
Q_proj = proj.projmap( Q - Q_o_s, vec2pix_func )
U_proj = proj.projmap( U - U_o_s, vec2pix_func )
...
TT, EE, BB, TE, EB, TB       = spice( (I-I_o_s,Q-Q_o_s,U-U_o_s ) )
...
imageQ = ax_Q.imshow( Q_proj,
                   ...
                   extent=( (-180,180,-90,90) ),
                   origin='lower')
pylab.colorbar( imageQ, ax=ax_Q, orientation='horizontal', ticks=[-5E-8,0,5E-8], format='%+2.2e' )
...
imageU = ax_U.imshow( U_proj,
                   ...
                   extent=( (-180,180,-90,90) ),
                   origin='lower')
pylab.colorbar( imageU, ax=ax_U, orientation='horizontal', ticks=[-5E-8,0,5E-8], format='%+2.2e' )
