...
# Zero out TT, EE and TE (no E-modes)
cl_TT_in *= 0.0
cl_EE_in *= 0.0
cl_TE_in *= 0.0
...
healpy.mollview( I , sub=(1,4,1) , fig=fig_maps)
healpy.mollview( Q , sub=(1,4,2) , fig=fig_maps)
healpy.mollview( U , sub=(1,4,3) , fig=fig_maps)
healpy.mollview( V , sub=(1,4,4) , fig=fig_maps)
...
pylab.show()
numpy.savez( './data/maps/lcdm_r=%1.3f_extra_noEE_0000_nside=%d.npz' % (r_value,out_nside), I=I, Q=Q, U=U, V=V, nside=out_nside )
