...
I_orig[ window ] = healpy.UNSEEN
Q_orig[ window ] = healpy.UNSEEN
U_orig[ window ] = healpy.UNSEEN
...
ax_BB.plot( ell, wl_BB, label='PISCO $w^{\mathrm{EE}}_\ell$') 
ax_BB.plot( ell, wl_BBo, label='Analytical $w^{\mathrm{EE}}_\ell$') 
ax_BB.legend()
