    ...
    for i,det in zip(range(2), pairs):
        ...
        if isOn[ idx0 ] == 1:
            ...
            data = deproject_sky_for_feedhorn( 
                      ...
                      # changed idx1 to idx0 in this case is correct, because otherwise we are computing 
                      # beam tensors from individual beams instead of a single "polarized" response.
                      beams[ idx0 ][   'co'], 
                      beams[ idx0 ][   'cx'],
