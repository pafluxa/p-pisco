...
# zeta is the polarization sensitive angle. Set to zero for PISCO compatibility
zeta = numpy.zeros_like( azOff )
ra, dec, pa = focalplane_to_equatorial(ra_bc, dec_bc, pa_bc + rotation, azOff, elOff, zeta) 

print ra.size, dec.size, pa.size

# save file
numpy.savez( output_file, ra=ra, dec=dec, pa=pa )
