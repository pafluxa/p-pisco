...
# put all pointing directions inside a pixel
#----------------------------------------------------------------------------------------------------------#
ipix = healpy.ang2pix(map_nside, numpy.pi / 2 - det_dec, det_ra)
det_tht, det_ra = healpy.pix2ang(map_nside, ipix)
det_dec = numpy.pi/2.0 - det_tht
#----------------------------------------------------------------------------------------------------------#
