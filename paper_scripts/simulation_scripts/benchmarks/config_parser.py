...
def parse_config_file( path ):
    ...
    # read beam nside and radius 
    beamNside  = parser.getint  ( 'Beams', 'beam nside' )
    beamMaxRho = parser.getfloat( 'Beams', 'beam radius' )
    
    opts[ 'beamcfg'] = {'nside':beamNside, 'maxRho': beamMaxRho }
