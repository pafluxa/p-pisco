...
# Adjust PS to have lmax elements
oTT = oTT[0:lmax+1]
oEE = oEE[0:lmax+1]
oBB = oBB[0:lmax+1]
...
# window functions
## gaussian beam with fwhm_sym
data.append( wl_TT )
data.append( wl_EE )
data.append( wl_BB )
## gaussian beams from composite window
data.append( wl_TT_mkb )
data.append( wl_EE_mkb )
data.append( wl_BB_mkb )
